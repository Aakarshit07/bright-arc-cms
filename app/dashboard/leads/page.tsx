...
//                     <CardDescription>Submitted on {new Date(contact.createdAt).toLocaleDateString()}</CardDescription>
//                   </div>
...
//                   <p className="text-sm text-muted-foreground bg-muted p-3 rounded-md">{contact.message}</p>
//                 </div>
//               </CardContent>
//             </Card>
//           ))}
